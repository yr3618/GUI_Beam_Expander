    ...
    def click():
        ...
        try:
            ...
            if 0.5 <= M <= 2:
                ...
                #Once the second distance sensor is implemented, we should use the value "M"
                #entered and call the moving_motor function in order to move the lenses properly.

            else:
                my_string_var.set("We are sorry but we cannot perform this at the moment.")
        except ValueError:
            my_string_var.set("A number please")
